...
class Starcast_Content_Display {
    ...
    public function enqueue_assets() {
        ...
        if ($has_lte_carousel) {
            ...
            wp_enqueue_style('starcast-lte-carousel', plugin_dir_url(__FILE__) . 'assets/lte-carousel.css', [], '1.5.6');
            wp_enqueue_script('starcast-lte-carousel', plugin_dir_url(__FILE__) . 'assets/lte-carousel.js', [], '1.5.6', true);
