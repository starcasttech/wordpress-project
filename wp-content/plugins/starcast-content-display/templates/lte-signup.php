...
@media (max-width: 768px) {
    .lte-signup-page { padding: 10px 0 0; min-height: auto; align-items: flex-start; }
    ...
    .router-summary { margin-top: 8px; padding-top: 8px; }
    .router-divider { margin-bottom: 6px; }
    .router-summary h5 { font-size: 0.85rem; margin-bottom: 4px; }
