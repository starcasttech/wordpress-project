...
class WC_Gateway_Ozow extends WC_Payment_Gateway {
    ...
    /**
     * Gateway configuration and API properties.
     * These are set from the plugin settings and used throughout the gateway logic.
     */
        protected $form_url;
        protected $token_url;
        ...
        protected $api_key;
        protected $allow_resend_payment_link;
...
?>
    ...
    public function process_refund($order_id, $amount = null, $reason = '') {
        ...
        if ($token) {
            ...
            $string_to_hash = strtolower(implode('', $data) . $private_key);
     ...
     *
     * @return string|null 'yes' if test mode is enabled, otherwise 'no'
     */
    ...
    /**
     * Get the allow resend payment link setting.
     *
     * @return string|null 'yes' if allowed, otherwise 'no'
     */
    public function get_allow_resend_payment_link() {
        return $this->allow_resend_payment_link;
    }
}
