...
if(!class_exists('Wt_Import_Export_For_Woo_Product_Review') ){
class Wt_Import_Export_For_Woo_Product_Review {
    ...
    */
    public function importer_steps($steps, $base)
    {
        ...
        {
            $steps['advanced']['description']=__('Use options from below to decide updates to existing reviews, batch import count or schedule an import. You can also save the template file for future imports.', 'wt-import-export-for-woo');
        }
        return $steps;
    }
...
//        $colunm = array_map(function($vl){ return array('title'=>$vl, 'description'=>$vl); }, $arr); 
	...
	$fields['limit']['help_text']=__('Exports specified number of reviews.', 'wt-import-export-for-woo');
        $fields['limit']['tip_description']=__('e.g. Entering 500 with a skip count of 10 will export reviews from 11th to 510th position.', 'wt-import-export-for-woo');
        $fields['offset']['label']=__('Skip first <i>n</i> reviews', 'wt-import-export-for-woo');
	$fields['offset']['help_text']=__('Skips specified number of reviews from the beginning', 'wt-import-export-for-woo');
        $fields['offset']['tip_description']=__('e.g. Enter 10 to skip first 10 reviews from export.', 'wt-import-export-for-woo');
