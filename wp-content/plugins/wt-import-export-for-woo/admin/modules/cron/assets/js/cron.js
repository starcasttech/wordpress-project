	...
	bind_save_schedule:function(ajx_dta, action, id)
	{
		jQuery('.wt_iew_save_schedule').unbind('click').click(function(){
			...
			*/
			...
			ajx_dta['schedule_data']={'schedule_type':schedule_type, 'schedule_name':schedule_name, 'interval':interval_vl, 'date_vl':date_vl, 'start_time':start_time, 'custom_interval':custom_interval, 'day_vl':day_vl, 'file_name':file_name};
