	    ...
	    bind_update_schedule:function()
	{
		jQuery('.wt_iew_update_schedule').unbind('click').click(function(){
			...
			*/
			...
			var schedule_name=jQuery.trim(jQuery('[name="wt_iew_cron_name"]').val());
			...
			*/
			...
			this.ajx_dta['schedule_data']={'schedule_type':schedule_type, 'schedule_name':schedule_name, 'interval':interval_vl, 'date_vl':date_vl, 'start_time':start_time, 'custom_interval':custom_interval, 'day_vl':day_vl, 'file_name':file_name};			
		...
		jQuery.ajax( {
		    ...
		    var start_time = response.data.cron_data.start_time;
                    var cron_name = response.data.cron_data.cron_name;
                    jQuery( '[name="wt_iew_cron_name"]' ).val( response.data.cron_data.cron_name );
