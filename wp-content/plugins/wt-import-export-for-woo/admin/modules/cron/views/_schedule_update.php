...
<!--	<ul class="wt_iew_sub_tab">
	...
	<div class="wt_iew_schedule_now_box">
		...
		<label><?php _e('Schedule name');?></label>
		<div class="wt_iew_schedule_now_formrow">
			<input type="text" name="wt_iew_cron_name" value="<?php echo isset($cron_data['schedule_name']) ?  esc_html($cron_data['schedule_name']) : '';?>" />
			<br />	
			<?php _e('Specify a unique name for the action.'); ?>	
		</div>		
