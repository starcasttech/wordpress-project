			...
			<tr>
				...
				<td>
					...
					if($action_type=='import' && Wt_Import_Export_For_Woo_Admin::module_exists($action_type))
					{
						...
						$raw_log_file_name = '';
						$raw_log_files = glob($log_path.'/'.$history_item['id'].'_*'.'.log');  
						if(is_array($raw_log_files) && count($raw_log_files)>0)
						{
							$raw_log_file_name=basename($raw_log_files[0]);				
						}
						...
						?>
							...
							| <a class="wt_iew_view_log_btn" data-log-file="<?php echo $raw_log_file_name;?>"><?php _e('Log', 'wt-import-export-for-woo');?></a>
						<?php
						}
					}
