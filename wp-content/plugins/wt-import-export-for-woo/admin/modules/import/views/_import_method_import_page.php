...
<div class="wt_iew_import_main">
	...
	<div class="wt_iew_warn wt_iew_method_import_wrn" style="display:none;">
		<?php _e('Please select an import template.', 'wt-import-export-for-woo');?>
	</div>
	<table class="form-table wt-iew-form-table">
		<tr>
			<th><label><?php _e('Import method', 'wt-import-export-for-woo');?></label></th>
			<td colspan="2" style="width:75%;">
                <div class="wt_iew_radio_block">
                    ...
                    foreach($this->import_obj->import_methods as $key => $value) 
                    {
                        ?>
                        <p>
                            <input type="radio" value="<?php echo $key;?>" id="wt_iew_import_<?php echo $key;?>_import" name="wt_iew_import_method_import" <?php echo ($this->import_method==$key ? 'checked="checked"' : '');?>><b><label for="wt_iew_import_<?php echo $key;?>_import"><?php _e($value['title'], 'wt-import-export-for-woo'); ?></label></b> <br />
                            <span><label for="wt_iew_import_<?php echo $key;?>_import"><?php _e($value['description'], 'wt-import-export-for-woo'); ?></label></span>
                        </p>
                        <?php
                    }
                    ?>
