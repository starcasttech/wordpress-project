...
?>
<div class="wt_iew_template_name wt_iew_popup" data-save-label="<?php _e('Save', 'wt-import-export-for-woo');?>" data-saveas-label="<?php _e('Save as', 'wt-import-export-for-woo');?>">
	...
	<div class="wt_iew_warn_box">
		<div class="wt_iew_warn wt_iew_template_name_wrn">
			<?php _e('Please enter name', 'wt-import-export-for-woo');?> 
		</div>
	</div>
	<div class="wt_iew_template_name_box">
		<label class="wt_iew_template_name_label"><?php _e('Template name', 'wt-import-export-for-woo');?></label>
		...
		<div class="wt_iew_popup_footer">
			<button type="button" name="" class="button-secondary wt_iew_popup_cancel">
				<?php _e('Cancel', 'wt-import-export-for-woo');?> 
			</button>
