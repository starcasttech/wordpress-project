...
<div class="wt-iew-tab-content" data-id="<?php echo esc_attr( $target_id ); ?>">
    <div class="wt_row"> 
        <div clas="wt_headings">
            <h1 class="wt_heading_1"><?php _e('More Plugins To Make Your Store Stand Out', 'wt-import-export-for-woo'); ?></h1>
            <h2 class="wt_heading_2"><?php _e('Check out our other plugins that are perfectly suited for WooCommerce store needs.', 'wt-import-export-for-woo'); ?></h2> 
        </div>
    <div class="wt_column">
<?php 

/* image location for the logos */
$wt_admin_img_path = WT_IEW_PLUGIN_URL . 'assets/images/other_solutions';

/* Plugin lists array */
$plugins=array(    
    'product_feed_sync' => array(
        'title'         => __('WebToffee WooCommerce Product Feed & Sync Manager', 'wt-import-export-for-woo'),
        'description'   => __('Generate WooCommerce product feeds for Google Merchant Center and Facebook Business Manager. Use the Facebook catalog sync manager to sync WooCommerce products with Facebook and Instagram shops.', 'wt-import-export-for-woo'),
    ...
    'request_quote' => array(
        'title'         => __('WebToffee Woocommerce Request a Quote', 'wt-import-export-for-woo'),
        'description'   => __('Configure a fully optimized WooCommerce quote request set up in your store. Allow customers to request quotes and store managers to respond to them. Hide product prices, set up email alerts, and more.', 'wt-import-export-for-woo'),
    ...
    'giftcards_plugin' => array(
        'title'         => __('WebToffee WooCommerce Gift Cards', 'wt-import-export-for-woo'),
        'description'   => __('Create and manage advanced gift cards for WooCommerce stores. Enable your customers to buy, redeem, and share gift cards from your store.', 'wt-import-export-for-woo'),
    ...
    'fbt_plugins' => array(
        'title'         => __('Frequently Bought Together for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Boost the visibility of the products by displaying them as ‘Frequently bought together’ items in your store. You may also set up discounts for Frequently Bought Together bundles with this plugin.', 'wt-import-export-for-woo'),
    ...
    'gdpr_cookie_consent_plugin' => array(
        'title'         => __('GDPR Cookie Consent Plugin (CCPA Ready)', 'wt-import-export-for-woo'),
        'description'   => __('The plugin helps you get compliant with GDPR, CCPA, and other major cookie laws. You can create and manage cookie consent banners, scan website cookies, and generate cookie policies with this plugin.','wt-import-export-for-woo'),
    ...
    'product_import_export_plugin' => array(
        'title'         => __('Product Import Export Plugin For WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Seamlessly import/export your WooCommerce products including simple, variable, custom products and subscriptions. You may also import and export product images, tags, categories, reviews, and ratings.', 'wt-import-export-for-woo'),
    ...
    'customers_import_export_plugin' => array(
        'title'         => __('WordPress Users & WooCommerce Customers Import Export', 'wt-import-export-for-woo'),
        'description'   => __('Easily import and export your WordPress users and WooCommerce customers using the Import Export plugin for WooCommerce. The plugin supports the use of CSV, XML, TSV, XLS, and XLSX file formats.', 'wt-import-export-for-woo'),
    ...
    'order_import_export_plugin' => array(
        'title'         => __('Order, Coupon, Subscription Export Import for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Export and Import your WooCommerce orders, subscriptions, and discount coupons using a single Import Export plugin. You may customize the export and import files with advanced filters and settings.', 'wt-import-export-for-woo'),
    ...
    'import_export_suit' => array(
        'title'         => __('Import Export Suite for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('An all-in-one plugin to import and export WooCommerce store data. You can import and export products, product reviews, orders, customers, discount coupons, and subscriptions using this single plugin.', 'wt-import-export-for-woo'),
    ...
    'smart_coupons_plugin' => array(
        'title'         => __('Smart Coupons for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Create coupons to offer discounts and free products to your customers with Smart Coupons for WooCommerce. You can set up BOGO coupons, giveaways, gift cards, store credits, and more with this plugin.', 'wt-import-export-for-woo'),
    ...
    'url_coupons_plugin' => array(
        'title'         => __('URL Coupons for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Generate custom URLs and QR codes for every discount coupon in your WooCommerce store. These unique coupons are easy to share and can even be set to add new products to the cart upon application.', 'wt-import-export-for-woo'),
    ...
    'paypal_express_checkout_plugin' => array(
        'title' => __('PayPal Express Checkout Payment Gateway for WooCommerce', 'wt-import-export-for-woo'),
        'description' => __('Offer a fast checkout experience to your customers with PayPal Payment Gateway. You can set up the PayPal Express Checkout option on the product pages to reduce the clicks to complete the checkout.', 'wt-import-export-for-woo'),
    ...
    'stripe_paymet_gateway_plugin' => array(
        'title' => __('WooCommerce Stripe Payment Gateway', 'wt-import-export-for-woo'),
        'description' => __('Ensure a fast and secure checkout experience for your users with WooCommerce Stripe Payment Gateway. Stripe accepts credit/debit cards and offers integrations with Apple Pay, SEPA, Alipay, and more.', 'wt-import-export-for-woo'),
    ...
    'subscriptions_for_woocommerce_plugin' => array(
        'title' => __('Subscriptions for WooCommerce', 'wt-import-export-for-woo'),
        'description' => __('Enable subscriptions on your WooCommerce store to sell products (physical and digital) and services that require accepting recurring payments. Supports both simple and variable subscription products.', 'wt-import-export-for-woo'),
    ...
    'sequential_order_plugin' => array(
        'title' => __('Sequential Order Numbers for WooCommerce', 'wt-import-export-for-woo'),
        'description' => __('Number your WooCommerce orders in a custom, sequential & manageable format. The Sequential Order Number plugin lets your orders follow a custom & unique numbering sequence suitable for your business.', 'wt-import-export-for-woo'),
	...
	'wt_ipc_addon' => array(
        'title'         => __('WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'wt-import-export-for-woo'),
        'description'   => __('Easily generate & print fully customized PDF Invoices, Packing Slips, and Credit Notes for your orders. Automatically send the documents to the recipients by attaching them to the order status emails.', 'wt-import-export-for-woo'),
    ...
    'wt_sdd_addon' => array(
        'title'         => __('WooCommerce Shipping Labels, Dispatch Labels and Delivery Notes', 'wt-import-export-for-woo'),
        'description'   => __('Automatically generate WooCommerce Shipping Labels, Dispatch Labels, and Delivery Notes with custom settings and layouts. Customize the label sizes and add extra product or order fields as required.', 'wt-import-export-for-woo'),
    ...
    'wt_pl_addon' => array(
        'title'         => __('WooCommerce Picklists', 'wt-import-export-for-woo'),
        'description'   => __('Customize, generate and print WooCommerce picklists for all orders on your store and automatically attach them to the order status emails. Add product variation data and other fields to the document.', 'wt-import-export-for-woo'),
    ...
    'wt_pi_addon' => array(
        'title'         => __('WooCommerce Proforma Invoices', 'wt-import-export-for-woo'),
        'description'   => __('Automate the generation of WooCommerce proforma invoices when new orders are placed and send them to your customers via order emails. Customize the layout and content of the invoice as per your needs.', 'wt-import-export-for-woo'),
    ...
    'wt_al_addon' => array(
        'title'         => __('WooCommerce Address Labels', 'wt-import-export-for-woo'),
        'description'   => __('Generate address labels for all orders in your store and easily print them in bulk. Customize the label layout and create labels of different types (shipping, billing, return, from address) with ease.', 'wt-import-export-for-woo'),
    ...
    'backup_and_migration_plugin' => array(
        'title' => __('WordPress Backup and Migration', 'wt-import-export-for-woo'),
        'description' => __('A complete WordPress backup and migration plugin to easily back up and migrate your WordPress website and database. This fast and flexible backup solution makes creating and restoring backups easy.', 'wt-import-export-for-woo'),
    ...
    'product_recommendations' => array(
        ...
        'description'   => __('Generate Intelligent Product Recommendations For Your WooCommerce Store. Offer WooCommerce smart product recommendations to your customers & maximize the average cart value.', 'wt-import-export-for-woo'),
