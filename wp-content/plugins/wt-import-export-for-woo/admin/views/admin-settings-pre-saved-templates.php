...
if (!empty($pre_saved_templates)):
    ...
    <div class="wt-ier-import-export-templates">
        <h3><?php _e('Import export pre-saved templates', 'wt-import-export-for-woo'); ?></h3>
        <div class="wt_ier_template_list_table_data">
        <table class="wt_ier_template_list_table">
            <thead>
                <tr>
                    <th style="width:50px;">#</th>
                    <th><?php _e('Name', 'wt-import-export-for-woo'); ?></th>
                    <th><?php _e('Item', 'wt-import-export-for-woo'); ?></th>
                    <th><?php _e('Type', 'wt-import-export-for-woo'); ?></th>
                    <th><?php _e('Action', 'wt-import-export-for-woo'); ?></th>                                
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                foreach ($pre_saved_templates as $key => $value):
                    ...
                    <tr data-row-id="<?php echo absint($value['id']); ?>">
                        ...
                        <td><button data-id="<?php echo absint($value['id']); ?>" title="<?php _e('Delete', 'wt-import-export-for-woo'); ?>" class="button button-secondary wt_ier_delete_template"><span><?php _e('Delete', 'wt-import-export-for-woo'); ?></span></button></td>
                    </tr>           
                    <?php
                    $num++;
                endforeach;
