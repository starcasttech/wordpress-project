...
class Wt_Import_Export_For_Woo_Activator {
	...
	public static function activate() 
	{
		...
		//update old version
		if(get_option('wt_plugin_old_version')){
			update_option('wt_plugin_old_version', WT_IEW_VERSION);
		}else{
			add_option('wt_plugin_old_version', WT_IEW_VERSION);
		}
	}
